 ...
 *
 * @export
 * @param {ReactNodeList} element:<App/>
 * @param {OpaqueRoot} container:div.root挂载的fiberRootNode
 * @param {?React$Component<any, any>} parentComponent:null
 * @param {?Function} callback:render arguments
 * @return {*}  {Lane}
 */
export function updateContainer(
  ...
  // 未开启concurrent模式，当前应该SyncLane：0b0000000000000000000000000000001
